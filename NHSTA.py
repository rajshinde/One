...
data = pd.read_csv('C:/Users/rajsh/Downloads/Manheim_VIN_Data.csv')
...
for x in range(0,total_api_calls):
    ...
    with open("C:/Users/rajsh/Desktop/Output.csv","a") as text_File:
...
df = pd.read_csv('C:/Users/rajsh/Desktop/Output.csv', encoding= 'unicode_escape')
df = df[df.makeid != 'makeid']
df.to_csv('C:/Users/rajsh/Desktop/Output.csv', index=False)
